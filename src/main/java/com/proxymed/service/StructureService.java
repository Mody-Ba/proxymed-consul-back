...
public class StructureService {
    ...
    /**
     * Reservee aux autres services qui doivent rattacher une structure a une entite
     * avant un appel repository (ex. MedecinService) : c'est la frontiere JPA, pas
     * une fuite de l'entite dans la logique metier.
     */
    public Structure getEntityById(Long id) {
